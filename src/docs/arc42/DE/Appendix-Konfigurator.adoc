...
Nachstehende Abbildung zeigt einen Konfigurator der Firma https://mygarden.gardena.com/de/[GARDENA(R)^].
...
https://hem.com/de/konfigurieren-aufbewahrung/?ref=stl.contact.cust_sub[Design-Möbel^]
...
Sonstige Anbieter von Online-Konfiguratoren mögen mir meine groben Vereinfachungen
oder Verkomplizierungen bitte verzeihen.  
--
****
