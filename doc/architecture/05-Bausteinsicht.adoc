...
| ATLAS Customs & Logistik | Teil- bzw. vollautomatische Generierung und Vergabe von Transportaufträgen
...
| Verträge mit Privatkunden:
  ...
  eine Schnittstelle dieser Komponente gelesen - die eigentliche Speicherung erfolgt in der <<User-Data-Service>>.
|
...
| Abwicklung von Verkäufen für Privat- und Firmenkunden,
  ...
  Enthält eine (relationale) Produktdatenbank auf Basis MySQL.
|
